...
<div class="main_div">
     ...
     <div class="navbar navbar-expand-md">
      ...
      <a href="#" class="navbar-brand font-weight-bold text-white text-center"><h2>PAISA HI PAISA BANK</h2></a>
     ...
     <div class="container">
        <div class="row">
          <div class="col-sm-6">
            <h1 class="main_text">PAISA HI PAISA BANK</h1>
            <p class="big-text">Money transfer is now at your fingertips and its instant..!</p>
          </div>
          <div class="col-sm-6">
  ...
  <section class="contactus" id="contact" >
        <div class="container headings text-center">
            ...
            <p>We're Here To Help And Answer Any Questions From You...We Look Forward To Hear From You..!</p>
        </div>
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-md-8 col-10 offset-lg-2 offet-md-2-col col-1">
                    <form action="/action_page.php">
                        ...
                        <button type="submit"><a href="action.html">Submit</a></button></div>
                      </form>
                </div>
            </div>
        </div>
       ...
       <footer><center>&#169; 2021 THE SPARKS FOUNDATION | DESIGNED BY GANESH BIPINCHANDRA SONAWANE</center></footer>
</body>
</html>